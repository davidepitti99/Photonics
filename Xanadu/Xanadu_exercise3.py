...
master_layout = gf.Component("50:50_DOE")

y_spacing = 30
y_offset = 0

# generate the DOS by iterating over the gap size and interaction lenght
for gap in gaps: 
...
master_layout.show()
master_layout.write_gds(r"C:\Users\Davide\Documents\GitHub\Photonics\Xanadu\\beamsplitter_DOE.gds")